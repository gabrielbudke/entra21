...
/**
 * 16. Faça um sistema que realize a conversão da temperatura, solicite os
 * seguintes dados: 
 *  -----> Temperatura;
...
public class Exercicio16 {
    public static void main(String[] args) {
        ...
        escalaOrigem = JOptionPane
                .showInputDialog(null, "Escolha a escala de origem:", "Conversor de temperatura!!",
                        JOptionPane.QUESTION_MESSAGE, null, new Object[] { "", "Celsius", "Kelvin", "Fahrenheit" }, "")
                .toString();

        // Lê a escala de destino que o usuário escolheu
        escalaDestino = JOptionPane
                .showInputDialog(null, "Escolha a escala de destino:", "Conversor de temperatura!!",
                        JOptionPane.QUESTION_MESSAGE, null, new Object[] { "", "Celsius", "Kelvin", "Fahrenheit" }, "")
                .toString();
