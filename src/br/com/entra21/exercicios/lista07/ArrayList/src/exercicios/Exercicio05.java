...
public class Exercicio05 {
    ...
    public static void main(String[] args) {
        ...
        String busca = JOptionPane.showInputDialog(null, "Qual nome deseja buscar?", "Buscar nome", JOptionPane.QUESTION_MESSAGE).toUpperCase().trim();                
        
        boolean nomeExiste = verificaSeNomeExiste(busca, nomes);
        
        if(nomeExiste) {
            JOptionPane.showMessageDialog(null, "O nome que está buscando já está contido no ArrayList!", "Buscar Nome", JOptionPane.INFORMATION_MESSAGE);            
        } else {
            JOptionPane.showMessageDialog(null, "O nome que está buscando NÂO está contido no ArrayList!", "Buscar Nome", JOptionPane.ERROR_MESSAGE);
        }
